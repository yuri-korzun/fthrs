...
import type { AdminService } from './users.class'
...
export const adminResolver = resolve<Admin, HookContext<AdminService>>({})

export const adminExternalResolver = resolve<Admin, HookContext<AdminService>>({
...
export const adminDataResolver = resolve<Admin, HookContext<AdminService>>({
...
export const adminPatchResolver = resolve<Admin, HookContext<AdminService>>({
  password: passwordHash({ strategy: 'local' })
})
